    ...
    <header class="mn-header navbar-fixed">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-3 " >
            <div class="nav-wrapper row">
                <marquee width="950px" direction="left" behavior="alternate" ><span style="font-size:38px; font-weight:bold;color:#1F7A8C;font-family:'lobster', cursive;">Order Management System</span>
                </marquee>
    ...
    <aside id="slide-out" class="side-nav white fixed">
        <div class="side-nav-wrapper">
            ...
            <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                <li class="no-padding">
                    <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">widgets</i>Options<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="{{route('Menu')}}">Menu</a></li>
                            <li><a href="{{route('order.index')}}">Previous Orders</a></li>
                        </ul>
                    </div>
                </li>
